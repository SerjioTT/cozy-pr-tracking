...
Обновлено: **2026-09-18**. Репозиторий по умолчанию — `cozystack/cozystack`, иначе указано явно. Все участники названы по никнеймам GitHub.
...
Пометки: `[вывод]` — выведено рассуждением из проверенных фактов, но прямо нигде не задокументировано; `[предположение]` — не проверено. Всё без пометки проверено по GitHub API на дату обновления.
